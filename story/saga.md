...
　ミラは指でもう一度、なぞった。今度は、粉塵そのものがなかった。乾いた、磨かれた大理石が、彼女の指の下にあるだけだった。
...
　頭の後ろから端子を抜く。室内は暗く、雨が窓を打っていた。〈バリーズ〉の煮詰まったコーヒーの匂いが、まだ鼻の奥にあった。仮想空間の二〇〇二年は、ほかには何も残していなかった。
...
この時代の端末は、ただの計算機ではない。内部には小さな神経培養基盤が
あり、認証、検索、記憶の下書き、会話の癖までを預かる。旧世紀のスマート
フォンと同じくらい、誰もがそれを持っていた。依頼の通知も、都市の監視
基盤を通ってそこへ届く。
...
　端末には、ルートドアキーの認証列が浮いていた。フロントテストダイバーにだけ
渡される業務用の鍵だ。正規の試験区なら、その認証で世界の裏口が開く。
描画前の地平線、閉じた区画、所有者がまだ商品名を付ける前の奥の層まで
入れる。だが鍵が保証するのは、入れる、ということだけだった。帰れるか
どうかは、いつも別の話だった。

　ミラは認証列を選んだ。通常なら、世界の側から短い応答が返る。許可、
...
　部屋へ戻ると、椅子の脇で、低い駆動音がした。リサだった。腰の高さの、無骨な小型
自走機。都市の監視基盤から切り離して動ける、古い自立型端末でもあった。
装甲の脇腹には〈ＬＩＺ〉と擦り切れたステンシルが残っている。
...
- **リサ（ＬＩＺ）** … ミラの二十年来のダイブ支援端末。腰の高さの古い自走機で、都市の監視基盤から切り離して動ける自立型端末。装甲の脇腹に〈ＬＩＺ〉のステンシル。内部に小さな神経培養基盤を持ち、ミラの左目の視神経と同期して、彼女の「手つき」を二十年ぶんログした。ミラの死後は最後の指示に従って、千年のあいだ「血ではなく形で」ハーロウの継承者を選び続けた。カイの前にも、何代かに一人、扉を叩いている。「ハーロウ」は血筋ではなく、リサが認定する継承の符牒。
