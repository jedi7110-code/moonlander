...
　四回分の生波形が、中央保管庫への送信待ちに入った。ナディアは送信を
止め、記録を〈機器側・再検査〉へ移した。表示面の隅で、送信灯が消えた。

　ナディアは試験を止め、端末を持って被験者室へ入った。ミラは首の端子を
抜き、筐体の背に身体を預けていた。

　ナディアは四回分の波形を並べ、端末をミラへ向けた。
...
研究職に就いてから初めて、測っていない順序を報告した。四回分の生波形は、
独立記録のまま作業地点へ移した。
